                    ...
                    <div className=" bg-white h-full justify-center items-center flex flex-col sm:h-auto sm:block p-8 rounded-lg shadow-md">
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <input id="email" type="text" className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-purple-500 focus:border-purple-500 sm:text-sm p-2 bg-white" value={email} onChange={handleEmailChange} />
                                <label htmlFor="phone" className="block text-sm font-medium text-gray-700">
                                    Teléfono
                                </label>
                                <input id="phone" type="text" className="mt-1 block w-full bg-white border-gray-300 rounded-md shadow-sm focus:ring-purple-500 focus:border-purple-500 sm:text-sm p-2" value={phone} onChange={handlePhoneChange}
                                />
                            </div>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                ...
                                                <input id="postalCode" type="text" className="mt-1 block w-full bg-white text-black border-gray-300 rounded-md shadow-sm focus:ring-purple-500 focus:border-purple-500 sm:text-sm" value={postalCode} onChange={handlePostalCodeChange} />
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <input id="firstName" type="text" className="mt-1 block w-full bg-white text-black border-gray-300 rounded-md shadow-sm focus:ring-purple-500 focus:border-purple-500 sm:text-sm" value={firstName} onChange={handleFirstNameChange} />
                                        </div>
                                        <div>
                                            <label htmlFor="lastName" className="block text-sm font-medium text-gray-700">
                                                Apellido
                                            </label>
                                            <input id="lastName" type="text" className="mt-1 block w-full bg-white text-black border-gray-300 rounded-md shadow-sm focus:ring-purple-500 focus:border-purple-500 sm:text-sm" value={lastName} onChange={handleLastNameChange} />
                                        </div>
                                        <div>
                                            <label htmlFor="address" className="block text-sm font-medium text-gray-700">
                                                Dirección
                                            </label>
                                            <input id="address" type="text" className="mt-1 block w-full bg-white text-black border-gray-300 roundedMis-md shadow-sm focus:ring-purple-500 focus:border-purple-500 sm:text-sm" value={address} onChange={handleAddressChange} />
                                        </div>
                                        <div>
                                            <label htmlFor="addressLine" className="block text-sm font-medium text-gray-700">
                                                Casa, Dpto, etc.
                                            </label>
                                            <input id="addressLine" type="text" className="mt-1 block w-full bg-white text-black border-gray-300 rounded-md shadow-sm focus:ring-purple-500 focus:border-purple-500 sm:text-sm" value={addressLine}
                                                onChange={handleAddressLineChange} />
                                        </div>

                                        {/* Checkbox para guardar información para futuras compras */}
                                        <div className="flex items-center">
                                            <input id="saveInfo" type="checkbox" className="mr-2 focus:ring-purple-500 h-4 w-4 before:bg-white bg-white active:bg-purple-500 border-gray-300 rounded" checked={saveInfo} onChange={handleSaveInfoChange} />

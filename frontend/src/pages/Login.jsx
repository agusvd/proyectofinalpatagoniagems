                ...
                <GoogleReCaptchaProvider reCaptchaKey="6LfxqAknAAAAADX06900xrbOBnjIZGUjcq7YQEZ4">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="m-2 items-center pt-4">
                            <button className="w-full bg-indigo-500 hover:bg-pink-500 duration-500 transition-all ease-in text-white font-bold py-2 px-4 mb-6 rounded-full" type="submit">
                                Entrar
                            </button>
                        </div>
